...
2. Second: a 3x3 grid icon (grid-cols-3, gap-[2px]) of 4px rounded cells alternating bg-white/60 and bg-white/0 in a checkerboard; value "12 Sessions" (same sizing); label "Healing Sessions" (text-xs sm:text-sm, font-light, text-white/60).
